<x-app-layout>
    ...
    <div class="bg-gray-50 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <p class="text-gray-600">"As a busy professional, I love how SkillConnect helps me find flexible volunteering options that fit my schedule. The impact tracking is really motivating too!"</p>
                <div class="mt-4 flex text-yellow-400">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
    ...
    <div class="gradient-bg text-white py-16">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4">
            <button class="bg-white text-blue-600 hover:bg-gray-100 px-8 py-4 rounded-full font-medium text-lg transition duration-300">
                Sign Up as Volunteer
            </button>
            <a href="{{ route('projects.create') }}" class="bg-blue-700 hover:bg-blue-800 text-white px-8 py-4 rounded-full font-medium text-lg transition duration-300">
